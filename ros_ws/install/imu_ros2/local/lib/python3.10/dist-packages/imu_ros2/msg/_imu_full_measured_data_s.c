...
bool imu_ros2__msg__imu_full_measured_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_ros2.msg._imu_full_measured_data.ImuFullMeasuredData", full_classname_dest, 56) == 0);
  }
  imu_ros2__msg__ImuFullMeasuredData * ros_message = _ros_message;
  {  // header
  ...
  {  // delta_velocity
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->delta_velocity)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ImuFullMeasuredData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_ros2.msg._imu_full_measured_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImuFullMeasuredData");
  ...
  {  // delta_velocity
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->delta_velocity);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "delta_velocity", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
