...
bool imu_ros2__msg__accel_gyro_temp_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_ros2.msg._accel_gyro_temp_data.AccelGyroTempData", full_classname_dest, 52) == 0);
  }
  imu_ros2__msg__AccelGyroTempData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of AccelGyroTempData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_ros2.msg._accel_gyro_temp_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AccelGyroTempData");
