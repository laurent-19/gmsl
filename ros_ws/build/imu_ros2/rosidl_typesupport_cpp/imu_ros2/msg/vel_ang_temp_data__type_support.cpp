...
static const _VelAngTempData_type_support_symbol_names_t _VelAngTempData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_ros2, msg, VelAngTempData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_ros2, msg, VelAngTempData)),
  }
};
...
{
  return &::imu_ros2::msg::rosidl_typesupport_cpp::VelAngTempData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, imu_ros2, msg, VelAngTempData)() {
  return get_message_type_support_handle<imu_ros2::msg::VelAngTempData>();
}
